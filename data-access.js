...
function createTables() {
  const itemTable = `-- DDL generated by Postico 1.4.3
...
`;
  ...
  const selectedItemsTable = `-- DDL generated by Postico 1.4.3
-- Not all database features are supported. Do not use for backup.
...
`;
  ...
  pool.query(itemTable).then(() => {
    pool.query(selectedItemsTable).then(() => pool.end(), () => pool.end());
  }, () => pool.end());
}
